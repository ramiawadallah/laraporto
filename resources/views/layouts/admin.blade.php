...
@endif()
	...
	<script src="{{ theme('js/select2/select2.min.js') }}"></script>
	<script src="{{ theme('js/bootstrap-tagsinput.min.js') }}"></script>
	<script src="{{ theme('js/typeahead.min.js') }}"></script>
	<script src="{{ theme('js/selectboxit/jquery.selectBoxIt.min.js') }}"></script>
	<script src="{{ theme('js/bootstrap-timepicker.min.js') }}"></script>
	<script src="{{ theme('js/bootstrap-datepicker.js') }}"></script>
	<script src="{{ theme('js/bootstrap-colorpicker.min.js') }}"></script>
	<script src="{{ theme('js/daterangepicker/daterangepicker.js') }}"></script>
