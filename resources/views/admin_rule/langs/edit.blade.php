	...
	<div class="col-xs-12">
	    ...
	    <div class="form-group">
			...
			<div data-toggle="buttons">
				<label class="btn btn-lg btn-block  btn-info {{ $lang->direction == 'ltr' ? 'active' : '' }}"><input tabindex="8" class="icheck-11" type="radio" value="ltr" id="minimal-radio-2-11" name="direction">{{ trans('lang.ltr') }}</label>
				<label class="btn btn-lg btn-block  btn-info {{ $lang->direction == 'rtl' ? 'active' : '' }}"><input tabindex="8" class="icheck-11" type="radio" value="rtl" id="minimal-radio-2-11" name="direction">{{ trans('lang.rtl') }}</label>
			
			    <label class="btn btn-lg btn-block  btn-primary @if($lang->default == 1) active @endif()">
